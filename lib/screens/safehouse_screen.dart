...
import '../services/protocolService.dart';
...
class _SafehouseScreenState extends State<SafehouseScreen> {
  ...
  late Future<Map<String, dynamic>> _protocolsFuture;
  ...
  void _initLoading() {
    _protocolsFuture = _protocolService.getProtocolsFromSupabase();
  }
